                                                    ...
                                                    <div className="absolute inset-x-0 bottom-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                                                        <div className="flex space-x-2">
                                                            <button
                                                                ...
                                                                className="flex-1 bg-gold text-bordeaux-dark py-2 text-sm uppercase tracking-wider font-medium flex items-center justify-center space-x-2 hover:bg-gold-light transition-colors"
                                                            >
                                                                <ShoppingBag size={16} />
                                                                <span>Ajouter</span>
                                                            </button>
